...
public class PaquetCarte {
    ...
    public List<Carte> distribuire(int nbJoueurs){
        ...
        if (age.getId().equals("age1") && tour.getAge()==age && tour.getNombreTourEnCours() >0 && tour.getNombreTourEnCours()<=age.getNombreTour()){
        ...
        else if (age.getId().equals("age2") && tour.getAge()==age && tour.getNombreTourEnCours() >0 && tour.getNombreTourEnCours()<=age.getNombreTour()){
        ...
        else if (age.getId().equals("age3") && tour.getAge()==age && tour.getNombreTourEnCours() >0 && tour.getNombreTourEnCours()<=age.getNombreTour()){
            if (cartesCollection.containsAll(BaseMongo.getBase().getCartesAges(age.getId()))){
                cartesCollection.removeAll(BaseMongo.getBase().getCartesAges(age.getId()));
            }
            Collections.shuffle(BaseMongo.getBase().getCartesAges(age.getId()));
