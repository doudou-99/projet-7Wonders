...
public class ScoreImpl implements Score {
    ...
    public ScoreImpl(Tour tour, Joueur joueur1, Joueur joueur2, Joueur joueur3, Joueur joueur4, String choixJoueur1, String choixJoueur2, String choixJoueur3, String choixJoueur4) {
        this.tour = tour;
    ...
    public int getNombreTourEnCours() {
        return this.tour.getNombreTourEnCours();
    }
}
